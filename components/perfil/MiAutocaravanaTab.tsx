...
export function MiAutocaravanaTab({ userId }: Props) {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Sección general: Diseños descargables para todos los vehículos */}
      <div className="mt-4 p-4 bg-white rounded-xl border border-gray-200 shadow-sm">
        <div className="mb-2">
          ...
          <p className="text-xs text-gray-600">
            Descarga un cartel llamativo para motivar a los testigos a reportar. Recomendado imprimir en tamaño A5 o A6. Pega tu QR dentro del recuadro.
          </p>
        </div>
        <div className="flex flex-col gap-4">
          ...
          <div className="bg-white rounded-lg border border-gray-200 overflow-hidden hover:shadow-md transition-shadow">
            <div className="w-full bg-white flex items-center justify-center p-3">
              <img src="/designs/qr-urgente.svg" alt="Diseño Urgente - ¿Viste un golpe?" className="w-full max-h-72 object-contain" />
            </div>
            <div className="p-3 flex items-center justify-between">
              ...
              <a
                ...
                download="Cartel-QR-Urgente.svg"
          ...
          <div className="bg-white rounded-lg border border-gray-200 overflow-hidden hover:shadow-md transition-shadow">
            <div className="w-full bg-white flex items-center justify-center p-3">
              <img src="/designs/qr-emocional.svg" alt="Diseño Emocional - Haz lo que te gustaría..." className="w-full max-h-72 object-contain" />
            </div>
            <div className="p-3 flex items-center justify-between">
              <div>
              ...
              <a
                ...
                download="Cartel-QR-Emocional.svg"
                className="px-3 py-1.5 bg-primary-600 text-white text-xs rounded-lg hover:bg-primary-700"
              >
                Descargar
              </a>
          ...
          <div className="bg-white rounded-lg border border-gray-200 overflow-hidden hover:shadow-md transition-shadow">
            <div className="w-full bg-white flex items-center justify-center p-3">
              <img src="/designs/qr-comunidad.svg" alt="Diseño Comunidad - Nos cuidamos entre todos" className="w-full max-h-72 object-contain" />
            </div>
            <div className="p-3 flex items-center justify-between">
              <div>
              ...
              <a
                ...
                download="Cartel-QR-Comunidad.svg"
                className="px-3 py-1.5 bg-primary-600 text-white text-xs rounded-lg hover:bg-primary-700"
              >
                Descargar
              </a>
