        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <Link href="/ruta" className="hover:text-white transition-colors">
          ...
          <div>
            ...
            <div className="space-y-3 text-sm">
              <div className="flex items-center gap-2">
                ...
                <div>
                  <div className="text-white font-semibold">+500 Áreas</div>
                  <div className="text-xs text-gray-500">En toda España</div>
                </div>
              </div>
              <div className="flex items-center gap-2">
                ...
                <div>
                  <div className="text-white font-semibold">Comunidad activa</div>
        ...
        <div className="border-t border-gray-800 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-gray-500">
            ...
            <p className="flex items-center gap-1">
              Hecho con <span className="text-red-500">❤️</span> para viajeros en autocaravana
            </p>
          </div>
        </div>
      </div>
